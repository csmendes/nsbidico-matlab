function Offspring = DE(Problem, Parent1, Parent2, Parent3, Parent4, Parameter)
...
%--------------------------------------------------------------------------
    ...
    Site = rand(N,D) < CR;
    Offspring       = Parent1;
    Offspring(Site) = Offspring(Site) + F*(Parent2(Site)-Parent1(Site) + Parent3(Site)-Parent4(Site));
