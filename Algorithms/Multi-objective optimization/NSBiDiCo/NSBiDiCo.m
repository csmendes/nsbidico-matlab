...
%--------------------------------------------------------------------------
	...
	methods
		function main(Algorithm,Problem)
			...
			[Cr, F, proM, disM] = Algorithm.ParameterSet(0.9, 0.95, 1, 20);
			...
			while Algorithm.NotTerminated(Population)		
				...
				Offspring  = OperatorDE(Problem, MatingPool(randi(Problem.N,1,Problem.N)), MatingPool(randi(Problem.N,1,Problem.N)), MatingPool(randi(Problem.N,1,Problem.N)));
